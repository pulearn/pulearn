...
if __name__ == "__main__":
    ...
    print(
        "Loading the Wisconsin breast cancer dataset from path:\n{}".format(
            fpath
        )
    )
    print("Loading data...")
    ...
    print("{} are benign.".format(len(np.where(y == -1.0)[0])))
    print("{} are malignant.".format(len(np.where(y == +1.0)[0])))
    ...
    print("{} are benign.".format(len(np.where(y_train == -1.0)[0])))
    print("{} are malignant.".format(len(np.where(y_train == +1.0)[0])))
    pu_f1_scores = []
    reg_f1_scores = []
    ...
    n_sacrifice_iter = range(0, len(np.where(y_train == +1.0)[0]) - 21, 5)
    ...
    for n_sacrifice in n_sacrifice_iter:
        ...
        print("{} are benign.".format(len(np.where(y_train_pu == -1.0)[0])))
        print("{} are malignant.".format(len(np.where(y_train_pu == +1.0)[0])))
        print("-------------------")
        print(
            (
